...
import OrderStatistics from './components/admin/OrderStatistics';  // ✅ 新增
...
// 主要應用程式內容
const AppContent = () => {
  const { currentUser, loading, isAdmin, isSuperAdmin } = useAuth();  // ✅ 新增 isAdmin, isSuperAdmin
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 to-purple-50">
        <div className="text-center">
          ...
          <p className="mt-6 text-gray-600 font-medium text-lg">載入中...</p>
        </div>
      </div>
    );
  }
