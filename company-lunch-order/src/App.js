...
const AppContent = () => {
  ...
  useEffect(() => {
    // 印出當前版本號以便驗證
    console.log('Current App Version: 0.2.0');
  ...
  const handleOrderComplete = () => {
    // 訂單已在 MobileOptimizedMenu 中建立並送出，這裡只需切換視圖
  ...
  if (currentView === 'storeManagement') {
    return <StoreManagement onBack={goHome} />;
  }
        ...
        {currentView === 'home' && (
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              {/* 午餐訂購卡片 */}
              <div className="group bg-white dark:bg-slate-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-slate-700 overflow-hidden">
              ...
              {/* 訂單記錄卡片 */}
              <div className="group bg-white dark:bg-slate-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-slate-700 overflow-hidden md:col-span-2 lg:col-span-1">
              ...
              {(isAdmin() || isSuperAdmin()) && (
                <div className="group bg-white dark:bg-slate-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-slate-700 overflow-hidden">
                  <div className="bg-gradient-to-r from-blue-500 to-indigo-600 p-6 text-white">
                    <div className="text-4xl mb-3">🏪</div>
                    <h3 className="text-xl font-bold mb-2">店家管理</h3>
                    <p className="text-blue-100">管理店家資料和菜單</p>
                  </div>
                  <div className="p-6">
                    <button
                      onClick={() => setCurrentView('storeManagement')}
                      className="w-full bg-blue-600 text-white px-6 py-3 rounded-xl font-medium hover:bg-blue-700 transition-colors"
                    >
                      進入管理
                    </button>
              ...
              {/* 批次修復工具卡片（僅超級管理員可見） */}
              {isSuperAdmin() && (
                <div className="group bg-white dark:bg-slate-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-red-100 dark:border-red-900/30 overflow-hidden">
            ...
            {/* 今日推薦 */}
            <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-8 mb-6 border border-gray-100 dark:border-slate-700">
              <div className="flex items-center mb-6">
                <div className="text-3xl mr-3">⭐</div>
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white">今日推薦</h3>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-gradient-to-r from-blue-50 to-indigo-100 dark:from-slate-700 dark:to-slate-600 p-6 rounded-xl border border-blue-200 dark:border-slate-500 hover:shadow-md transition-shadow">
                  <div className="flex items-center justify-between mb-3">
                    <h4 className="text-lg font-bold text-blue-900 dark:text-blue-100">富家小鋪</h4>
                    <span className="bg-red-500 text-white text-xs px-2 py-1 rounded-full">熱門</span>
                  </div>
                  <p className="text-blue-700 dark:text-blue-200 font-semibold mb-2">香爆牛肉蓋飯 - NT$90</p>
                  <p className="text-blue-600 dark:text-blue-300 text-sm">經典台式風味，香嫩多汁</p>
                </div>
                <div className="bg-gradient-to-r from-green-50 to-emerald-100 dark:from-stone-700 dark:to-stone-600 p-6 rounded-xl border border-green-200 dark:border-stone-500 hover:shadow-md transition-shadow">
                  <div className="flex items-center justify-between mb-3">
                    <h4 className="text-lg font-bold text-green-900 dark:text-green-100">MACU 果粒茶</h4>
                    <span className="bg-orange-500 text-white text-xs px-2 py-1 rounded-full">推薦</span>
                  </div>
                  <p className="text-green-700 dark:text-green-200 font-semibold mb-2">香橙果粒茶 - NT$75</p>
                  <p className="text-green-600 dark:text-green-300 text-sm">新鮮果粒，清香回甘</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-white dark:bg-slate-800 p-4 rounded-xl shadow-sm border border-gray-100 dark:border-slate-700 text-center">
                ...
                <div className="text-sm text-gray-600 dark:text-gray-400">合作店家</div>
              </div>
              <div className="bg-white dark:bg-slate-800 p-4 rounded-xl shadow-sm border border-gray-100 dark:border-slate-700 text-center">
                <div className="text-2xl font-bold text-green-600 dark:text-green-400">50+</div>
                <div className="text-sm text-gray-600 dark:text-gray-400">精選商品</div>
              </div>
              <div className="bg-white dark:bg-slate-800 p-4 rounded-xl shadow-sm border border-gray-100 dark:border-slate-700 text-center">
                <div className="text-2xl font-bold text-purple-600 dark:text-purple-400">15-30</div>
                <div className="text-sm text-gray-600 dark:text-gray-400">分鐘送達</div>
              </div>
              <div className="bg-white dark:bg-slate-800 p-4 rounded-xl shadow-sm border border-gray-100 dark:border-slate-700 text-center">
                <div className="text-2xl font-bold text-orange-600 dark:text-orange-400">4.5★</div>
                <div className="text-sm text-gray-600 dark:text-gray-400">平均評分</div>
              </div>
            </div>
          </>
        )}
